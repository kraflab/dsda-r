...
Category.create!(name: "SM Speed",    description: "")
...
Category.create!(name: "SM Max",      description: "")
...
Category.create!(name: "BP Max",      description: "")
...
Category.create!(name: "BP Speed",    description: "")
